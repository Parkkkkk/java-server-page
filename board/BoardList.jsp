...
<%
	...
	<TR>
		...
		<TD WIDTH=395 ALIGN=LEFT><A HREF="BoardContent.jsp?rno=<%=rno%>&column=<%=column%>
		&key=<%=encoded_key%>"><%=subject %></A></TD>
...
<TABLE WIDTH=620 HEIGHT=50 BORDER=0 CELLSPACING=1 CELLPADDING=1 ALIGN=CENTER>
	...
	<TR>
		<TD ALIGN=LEFT WIDTH=100>
			<IMG SRC="../images/btn_new.gif" onClick="javascript:location.replace('BoardWrite.jsp?column=<%=column %>
			&key=<%=encoded_key %>')"; STYLE=CURSOR:HAND>
		</TD>
